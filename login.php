          ...
          <div class="col-md-6 order-md-last ftco-animate makereservation p-4 p-md-5 pt-5">
          	<div class="py-md-5">
	          	<div class="heading-section ftco-animate mb-5">
		          	<span class="subheading">Fisrt Login</span>
	            ...
	            <form action="login_submit.php" method="POST">           
                  ...
                  <span>Don't have Account ? Create a new one, Pls <a href="register.php"> click here</a></span>
	            </form>
	          </div>
            </div>
                <div class="col-md-6 d-flex align-items-stretch pb-5 pb-md-0 ftco-section ftco-wrap-about">
                    <div class="col-md-12 d-flex">
					    <div class="img img-1 mr-md-2" style="background-image: url(images/image_2.jpg);"></div>
					</div>
			    </div>
           </div>
		</div>
